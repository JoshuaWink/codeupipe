...
<!-- cup:ref file=codeupipe/deploy/init.py symbols=init_project,list_templates hash=fe139cd -->
...
<!-- cup:ref file=codeupipe/cli.py symbols=main,scaffold,bundle,lint,coverage,report,doc_check hash=001e289 -->
| Command | Purpose |
|---------|---------||
